...
<body background ="https://naturalhistory.si.edu/arctic/isc18/images/EastFront_night.jpg"><div>
 ...
 <!-- <div class="gap"></div> -->
  <nav class="navbar navbar-inverse" role="navigation">
    ...
    <div class="container-fluid white-container text-center">
        <br><br>
        <font color="black"><h2>Positive Tweets Mentioning Donald Trump Since December 1st, 2016:</h2></font>
	<font color="white"><h1>'''
                print count
	        print '''</h1></font>
	<font color = "black"><h2>What Are Those Tweets Saying?</h2>
	<font color = "white"><h1>
	'''
	        print tweetOut
	        print '''</h1>
